...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.headerReferenceSize = CGSizeMake(IPHONE_WIDTH, 65.0f);//头部视图的框架大小
        
        CGFloat itemWidth = IPHONE_WIDTH / 7;
        CGFloat itemHeight = itemWidth + 25;
        
        self.itemSize = CGSizeMake(itemWidth, itemHeight);//每个cell的大小
