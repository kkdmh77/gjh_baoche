...
#define Common_InkBlackColor                HEXCOLOR(0X2C2F46)                  // 墨黑色  适用范围:TAB未选中状态的主标题
#define Common_InkGreenColor                HEXCOLOR(0X7A97A1)                  // 墨绿色  适用范围:TAB的子标题
#define Common_LiteBlueColor                HEXCOLOR(0X0059FF)                  // 浅蓝色  适用范围:TAB选中状态的主标题
#define Common_OrangeColor                  HEXCOLOR(0XFF8C00)                  // 橙黄色  适用范围:产品详情页 价格、选择按钮选中边框、购物车按钮等的颜色

#define PageBackgroundColor                 HEXCOLOR(0XFFFFFF)                  // 灰蓝色  viewController的背景色
...
#define Common_ThemeColor                   HEXCOLOR(0XB60004)                  // 换了LOGO后的主题颜色
