...
@interface MonitoringDataListVC ()
{
...
@implementation MonitoringDataListVC
...
- (void)setNetworkRequestStatusBlocks
{
    ...
    [self setNetSuccessBlock:^(NetRequest *request, id successInfoObj) {
        STRONGSELF
        if (NetWaterPressureRequestType_GetMonitoringDataList == request.tag)
        {
...
- (void)getNetworkData
{
    ...
    requestMethodType:RequestMethodType_POST
           requestTag:NetWaterPressureRequestType_GetMonitoringDataList];
}
...
- (NSArray *)parseNetwordDataWithInfoObj:(NSDictionary *)obj
{
    ...
    {
        MonitoringDataListEntity *entity = [MonitoringDataListEntity initWithDict:dic];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.handle = ^(ShuiYaCell *cell, id sender) {
        ...
        MonitoringDataListEntity *data = strongSelf->_netEntityArray[path.row];
    ...
    MonitoringDataListEntity *entity = _netEntityArray[indexPath.row];
