...
- (void)configureBarbuttonItemByPosition:(BarbuttonItemPosition)position normalImg:(UIImage *)normalImg highlightedImg:(UIImage *)highlightedImg action:(SEL)action
{
    ...
    {
        self.navigationItem.leftBarButtonItem = [UIBarButtonItem barButtonItemWithFrame:CGRectMake(0, 0, 35, 35) normalImg:normalImg highlightedImg:highlightedImg target:self action:action];
    }
    else
    {
        self.navigationItem.rightBarButtonItem = [UIBarButtonItem barButtonItemWithFrame:CGRectMake(0, 0, 35, 35) normalImg:normalImg highlightedImg:highlightedImg target:self action:action];
    }
}
