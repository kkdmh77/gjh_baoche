...
// 常规文字颜色
#define Common_LiteGrayColor                HEXCOLOR(0X8B8B8B)                  // 浅灰色  适用范围:TAB的子标题
#define Common_BlackColor                   HEXCOLOR(0X000000)                  // 黑色    适用范围:TAB未选中状态的主标题
...
#define LineWidth                           1                   // 全局线宽值  适用范围:cell的分割线、视图边框线宽
