...
//                    NSString* path = [[NSBundle mainBundle] pathForResource:@"myFile" ofType:@"gif"];
                    
                    NSArray *searchPaths = nil;
                    NSString *path = nil;
                    searchPaths = NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES);
                    path = [NSString stringWithFormat:@"%@/%@",[searchPaths objectAtIndex: 0],@"YungFile.gif"];
					...
					[WBRequest appendUTF8Body:body dataString:[NSString stringWithString:@"Content-Type: image/gif\r\nContent-Transfer-Encoding: binary\r\n\r\n"]];
