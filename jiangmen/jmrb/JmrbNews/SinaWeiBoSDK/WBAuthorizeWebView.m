...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 480)])
    {
        ...
        [btn setFrame:CGRectMake(280, 20, 50, 50)];
        [btn setTransform:CGAffineTransformMakeRotation(M_PI/4)];
...
- (void)cancelLogin {
    if (delegate && [delegate respondsToSelector:@selector(authorizeWebViewCancelLogin)]) {
        [delegate authorizeWebViewCancelLogin];
    }
    [self hide:YES];
}
