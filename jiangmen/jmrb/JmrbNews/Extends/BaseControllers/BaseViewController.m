...
- (void)viewDidLoad
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageWithColor:HEXCOLOR(0XF4F4F4) size:CGSizeMake(1, 1)] forBarMetrics:UIBarMetricsDefault];
