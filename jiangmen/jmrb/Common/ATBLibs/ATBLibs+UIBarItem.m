...
{
    return [self barButtonItemWithFrame:frame tag:tag normalImg:normalImg highlightedImg:highlightedImg title:title titleFont:[UIFont boldSystemFontOfSize:15] titleColor:Common_BlueColor target:target action:action];
}
