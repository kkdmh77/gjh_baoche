...
@protocol MainPageNewInfoDetailDelegate;

@interface MainPageNewInfoDetail : UIViewController<UIActionSheetDelegate> {
...
@property (nonatomic, assign) id<MainPageNewInfoDetailDelegate> delegate;
...
@protocol MainPageNewInfoDetailDelegate <NSObject>
