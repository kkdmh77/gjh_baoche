...
- (id)initWithAppKey:(NSString *)theAppKey appSecret:(NSString *)theAppSecret
{
    if (self = [super init])
    {
        ...
        self.redirectURI=@"http://www.sina.com.cn";
        isUserExclusive = NO;
...
- (void)authorizeCancelLogin {
    if (delegate && [delegate respondsToSelector:@selector(engineCancelLogin)]) {
        [delegate engineCancelLogin];
    }
}
