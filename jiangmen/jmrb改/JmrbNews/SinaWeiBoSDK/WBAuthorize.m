...
//    UIView *view = [window viewWithTag:WebViewTag];
//    if (view) {
//        [(WBAuthorizeWebView *)view hide:YES];
//    }
//}
...
//    WBAuthorizeWebView *webView = [[WBAuthorizeWebView alloc] initWithFrame:CGRectMake(32, 50, 960, 668)];
...
- (void)authorizeWebViewCancelLogin {
    if (delegate && [delegate respondsToSelector:@selector(authorizeCancelLogin)]) {
        [delegate authorizeCancelLogin];
    }
}
